...
public class score {
	...
	@ResponseBody
	public ModelMap getul(@RequestParam("url") String url_g, @RequestParam("modelname") String modelname)
			throws Exception {
		...
		if (result != null) {
			...
			/*
			 * String resultDic=result.substring(2,result.length()-2); String[]
			 * Diclist=resultDic.split("\", \""); for(String i:Diclist) { String[]
			 * row=i.split("\": \""); Return.put(row[0], row[1]); }
			 *
			 */
			return Return;
		} else
	...
	/*
	 * public static void main(String[] arg) { score A=new score(); ModelMap Return
	 * =null; try { Return =A.getul(
	 * "https://cs1f9abf47a9b73x49c3x9c1.blob.core.windows.net/modelblob1/111/timg.jpg"
	 * ); } catch (Exception e) { // TODO Auto-generated catch block
	 * e.printStackTrace(); } System.out.print(Return); }
	 */
}