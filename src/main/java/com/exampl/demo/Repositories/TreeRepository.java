...
public class TreeRepository implements Treedao{
    ...
    private static final String SQL_FIND_ALL = "SELECT * FROM nyTree";
   // private static final String SQL_FIND_BY_NAME = "SELECT * FROM myUser WHERE user_id = :user_id";
    ...
    private static final String SQL_INSERT = "INSERT INTO nyTree (t_id, t_name,t_pid) values(:t_id, :t_name ,:t_pid)";
